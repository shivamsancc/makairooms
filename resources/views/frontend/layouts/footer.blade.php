        ...
        <div class="modal-body">
          <form action="{{route('helpquerysubmit')}}" method="POST">@csrf
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" required id="name" aria-describedby="helpId" placeholder="John Doe">
                <small id="helpId" class="form-text text-muted">Enter Your Name</small>
              </div>
              <div class="form-group">
                <label for="" class="text-dark font-weight-bold">Email</label>
                <input type="text" class="form-control" name="email" required id="email" aria-describedby="helpId" placeholder="johndoe@gmail.com">
                <small id="helpId" class="form-text text-muted">Enter your Email</small>
              </div>
              <div class="form-group">
                <label for="" class="text-dark font-weight-bold" >Phone</label>
                <input type="text" class="form-control" name="phone" required id="phone" aria-describedby="helpId" placeholder="85xxxxxx53">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                <div class="footer_contact_widget">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="text-white"><span class="flaticon-email mr15"></span><a href="mailto:support@makairooms.com">support@makairooms.com</a></li>
                    </ul>
                </div>
            </div>
