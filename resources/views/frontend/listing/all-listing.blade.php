        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb_content style2 mb0-991">
                    <h2 class="breadcrumb_title">Listing V1</h2>
                    <ol class="breadcrumb">
            ...
            <div class="col-xl-9">
                ...
                <div class="row">
                            ...
                            <div class="thumb">
                                ...
                                <div class="thmb_cntnt">
                                    ...
                                    <ul class="listing_reviews">
                                        ...
                                        <li class="list-inline-item"><a class="text-white" href="#"><span
                                                    class="fa fa-star"></span></a></li>
                                        <li class="list-inline-item"><a class="text-white total_review" href="#">(5
                                                Review)</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{ asset('/web/themes/guido') }}/images/listing/lg2.jpg"
                                    alt="lg2.jpg">
                                <div class="thmb_cntnt">
                                    <ul class="tag mb0">
                                        <li class="list-inline-item"><a href="#">$$$$</a></li>
                            ...
                            <div class="details">
                                <div class="tc_content">
                                    <div class="badge_icon"><a href="#"><img
                                                src="{{ asset('/web/themes/guido') }}/images/icons/agent4.svg"
                                                alt="agent4.svg"></a></div>
                                ...
                                <div class="fp_footer">
                                    <ul class="fp_meta float-left mb0">
                                        <li class="list-inline-item"><a href="#"><img
                                                    src="{{ asset('/web/themes/guido') }}/images/icons/icon8.svg"
                                                    alt="icon8.svg"></a></li>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{ asset('/web/themes/guido') }}/images/listing/lg3.jpg"
                                    alt="lg3.jpg">
                                <div class="thmb_cntnt">
                                    <ul class="tag mb0">
                                        <li class="list-inline-item"><a href="#">$$$$</a></li>
                            ...
                            <div class="details">
                                <div class="tc_content">
                                    <div class="badge_icon"><a href="#"><img
                                                src="{{ asset('/web/themes/guido') }}/images/icons/agent5.svg"
                                                alt="agent5.svg"></a></div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{ asset('/web/themes/guido') }}/images/listing/lg5.jpg"
                                    alt="lg5.jpg">
                                <div class="thmb_cntnt">
                                    <ul class="tag mb0">
                                        <li class="list-inline-item"><a href="#">$$$$</a></li>
                            ...
                            <div class="details">
                                ...
                                <div class="fp_footer">
                                    <ul class="fp_meta float-left mb0">
                                        <li class="list-inline-item"><a href="#"><img
                                                    src="{{ asset('/web/themes/guido') }}/images/icons/icon6.svg"
                                                    alt="icon6.svg"></a></li>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{ asset('/web/themes/guido') }}/images/listing/lg4.jpg"
                                    alt="lg4.jpg">
                                <div class="thmb_cntnt">
                                    <ul class="tag mb0">
                                        <li class="list-inline-item"><a href="#">$$$$</a></li>
                            ...
                            <div class="details">
                                <div class="tc_content">
                                    <div class="badge_icon"><a href="#"><img
                                                src="{{ asset('/web/themes/guido') }}/images/icons/agent6.svg"
                                                alt="agent6.svg"></a></div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="feat_property">
                            <div class="thumb">
                                <img class="img-whp" src="{{ asset('/web/themes/guido') }}/images/listing/lg6.jpg"
                                    alt="lg6.jpg">
                                <div class="thmb_cntnt">
                                    <ul class="tag mb0">
                                        <li class="list-inline-item"><a href="#">$$$$</a></li>
                            ...
                            <div class="details">
                                <div class="tc_content">
                                    <div class="badge_icon"><a href="#"><img
                                                src="{{ asset('/web/themes/guido') }}/images/icons/agent7.svg"
                                                alt="agent7.svg"></a></div>
                                ...
                                <div class="fp_footer">
                                    <ul class="fp_meta float-left mb0">
                                        <li class="list-inline-item"><a href="#"><img
                                                    src="{{ asset('/web/themes/guido') }}/images/icons/icon7.svg"
                                                    alt="icon7.svg"></a></li>
