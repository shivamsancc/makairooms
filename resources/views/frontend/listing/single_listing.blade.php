                        ...
                        <div class="media-body mt20">
                            ...
                            <ul class="mb0 agency_profile_contact">
                                <li class="list-inline-item"><a href="#"><span
                                            class="flaticon-phone"></span>&nbsp;{{$partnername['0']->phone}}</a></li>
                                <li class="list-inline-item"><a href="#"><span
                        ...
                        <div class="listing_single_reviews">
                            <div class="product_single_content mb30">
                                <div class="mbp_first media mb30">
                                    <img src="{{ asset('/web/themes/guido') }}/images/blog/reviewer1.png" class="mr-3"
                                        alt="reviewer1.png">
                                    <div class="media-body">
                                        ...
                                        <p class="fz14 mt10">Every single thing we tried with John was delicious! Found
                                            some awesome places we would definitely go back to on our trip. John was
                                            also super friendly and passionate about Beşiktaş and Istanbul. we had an
                                            awesome time!</p>
                                        <div class="thumb-list mt30">
                                            <ul>
                                                <li class="list-inline-item mb10-lg"><a href="#"><img
                                                            src="{{ asset('/web/themes/guido') }}/images/blog/bsp1.jpg"
                                                            alt="bsp1.jpg"></a></li>
                                                <li class="list-inline-item mb10-lg"><a href="#"><img
                                                            src="{{ asset('/web/themes/guido') }}/images/blog/bsp2.jpg"
                                                            alt="bsp2.jpg"></a></li>
                                                <li class="list-inline-item mb10-lg"><a href="#"><img
                                                            src="{{ asset('/web/themes/guido') }}/images/blog/bsp3.jpg"
                                                            alt="bsp3.jpg"></a></li>
                                                <li class="list-inline-item mb10-lg"><a href="#"><img
                                                            src="{{ asset('/web/themes/guido') }}/images/blog/bsp4.jpg"
                                                            alt="bsp4.jpg"></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="mbp_first media">
                                    <img src="{{ asset('/web/themes/guido') }}/images/blog/reviewer2.png" class="mr-3"
                                        alt="reviewer2.png">
                                    <div class="media-body">
                                        ...
                                        <p class="fz14 mt10">I enjoyed the tour. John is very friendly, observant, and
                                            funny. He cares for the guests and really works hard on providing a good
                                            experience by understanding each person's needs.…</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="listing_single_sidebar">
                    <div class="lss_contact_location ">
                        ...
                        <ul class="contact_list list-unstyled mb15">
                            ...
                            <li><span class="flaticon-phone mr15"></span><a href="#">{{$partnername['0']->phone}}</a>
                            </li>
                            <li><span class="flaticon-email mr15"></span><a href="#">{{$partnername['0']->mail}}</a>
                            </li>
                    ...
                    {{-- <div class="sidebar_category_widget">
                        ...
                        <ul class="mb0">
                            <li class="mb25"><a href="#"><img class="mr5"
                                        src="{{ asset('/web/themes/guido') }}/images/icons/icon3.svg" alt="icon3.svg">
                                    Outdoor Activity</a></li>
                            <li class="mb25"><a href="#"><img class="mr5"
                                        src="{{ asset('/web/themes/guido') }}/images/icons/icon4.svg" alt="icon4.svg">
                                    Restourant</a></li>
                            <li><a href="#"><img class="mr5"
                                        src="{{ asset('/web/themes/guido') }}/images/icons/icon5.svg" alt="icon5.svg">
                                    Hotels</a></li>
                        </ul>
                    </div> --}}
