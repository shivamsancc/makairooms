...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add Property</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <form action="{{route('partneradd_pgpost')}}"  name="propertyform" method="post" enctype="multipart/form-data" role="form">@csrf
                    ...
                    <input type="hidden" name="partner_id" value="{{AUTH::user()->id}}">  
                        ...
                        <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text"
                                class="form-control" name="degree_link" id="degree_link" aria-describedby="helpId" placeholder="360 Degreee Link">
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="about_property" id="about_property" rows="3"></textarea>
                          </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input type="number"
                              class="form-control" name="price_range1" id="price_range1" aria-describedby="helpId" placeholder="">
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <input type="number"
                              class="form-control" name="price_range2" id="price_range2" aria-describedby="helpId" placeholder="">
                            <small id="helpId" class="form-text text-muted">Enter Last Price</small>
                          </div>
                        </div>
                        @include('partnerdashboard.layout.template.features')
                        <div class="col-4">
                            <div class="form-group">
