    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form action="{{route('partnercreatepropertystore')}}" enctype="multipart/form-data" class="form" role="form"
                    method="post">@csrf
                    <div class="row m-0 p-0">
                                <input type="hidden" name="partner_id" id="partner_id" value="{{Auth::user()->id}}">
                        <div class="col-4">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" name="images[]" multiple="multiple"
                                    id="imges" placeholder="****" aria-describedby="fileHelpId">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var stateID = document.getElementById("partner_id").value;
        if (stateID) {
            $.ajax({
                type: "GET",
