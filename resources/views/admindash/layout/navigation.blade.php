...
{{--==========================Master Setinng============================= --}}
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsequery" aria-expanded="true"
        aria-controls="collapsequery">
        <i class="fab fa-blogger"></i>
        <span>Query</span>
    </a>
    <div id="collapsequery" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Blog </h6>
            <a class="collapse-item" href="{{route('listingquery')}}">Listing Query</a>
            <a class="collapse-item" href="{{route('helpquery')}}">Help Query</a>
        </div>
    </div>
</li>
    <!-- Nav Item - Pages Collapse Menu -->
