...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add PG</h1>
    </div>
    <!-- Content Row -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add PG</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="row m-0 p-0">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="partner_id" required id="partner_id">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pincode" id="pincode"
                                    aria-describedby="helpId" placeholder="" maxlength="6">
